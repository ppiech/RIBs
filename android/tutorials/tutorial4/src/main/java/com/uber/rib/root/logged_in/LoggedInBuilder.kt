...
class LoggedInBuilder() : Builder<LoggedInRouter, Any>(Object()) {
     ...
     */
    fun build(rootView: RootView, playerOne: UserName, playerTwo: UserName): LoggedInRouter {
        val interactor = LoggedInInteractor(Board(), playerOne, playerTwo)
